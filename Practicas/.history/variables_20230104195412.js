...
class Personaje {
    ...
    constructor(type) {
      this.type = type;   // Modificamos el valor de la propiedad name
      console.log(`¡Bienvenido/a, ${this.type}!`);  // Accedemos al valor actual de la propiedad name
    }
  }
  
  const gamer = new Personaje("Mario");   // '¡Bienvenido/a, Mario!'
