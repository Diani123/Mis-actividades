          ...
          <div>
            <figure>
              <img
                ...
                srcset="https://terrigen-cdn-dev.marvel.com/content/prod/1x/marvel_insider-topnav-logo-large2x.png"
                alt="Logotipo de Marvel Insider"
                classn="main-footer__promotion-image"/>
            </figure>
          </div>
          <div>
            <h4>INFORMACION PRIVILEGIADA DE MARVEL</h4>
            <p>Obten recompensas por ser fanàtico de marvel</p>
          </div>
        </a>
      </nav>
    </div>
